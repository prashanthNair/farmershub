  ...
  liveStocks: [
    {
      ...
      icon: "cow",
      color: "#f2a463",
      imageUrl: require("../../assets/new/cow.jpg"),
    },
    {
      id: 2,
      title: "Goat",
    ...
    },
    {
      ...
      icon: "bullseye",
      color: "#deb69b",
       imageUrl: require("../../assets/new/buffalo.jpg"),
    },
    {
      id: 4,
      title: "Pets",
      icon: "dog-side",
      color:'#d4f099',
      imageUrl: require("../../assets/new/pets.jpg"),
    },
    {
      id: 5,
      icon: "ladybug",
      color: "#f2d5ef",
      title: "Poultry",
      imageUrl: require("../../assets/new/poultry.jpg"),
    },
  ],
  ...
  farmItems: [
    {
      ...
      imageUrl: require("../../assets/new/farm.jpg"),
    },
    {
      id: 2,
      title: "Machinery",
      color: "#baa7d6",
      icon: "hammer",
      imageUrl: require("../../assets/new/machinery.jpg"),
    },
    {
      id: 3,
      title: "Vehicle",
      color: "#dea28e",
      icon: "car",
      imageUrl: require("../../assets/new/tractor.jpg"),
    },
    {
      id: 4,
      title: "Feed",
      color: "#7d91c7",
      icon: "food-variant",
      imageUrl: require("../../assets/new/feeds.jpg"),
    },
    {
      id: 5,
      title: "Job",
      ...
      imageUrl: require("../../assets/new/job.jpg"),
    },
  ],
};
